...
if REPORTING_AVAILABLE:
    ...
    print("  [OK] Professional Engineering Reports")
    print("  [OK] Code Compliance Verification")
    print("  [OK] Project Documentation Packages")
    print("  [OK] Multi-format Output (HTML, PDF, Text)")
    print("  [OK] Industry-standard Documentation")
    print("")
    print("Supported Codes:")
    print("  [OK] AISC 360-16 (Steel Design)")
    print("  [OK] ACI 318-19 (Concrete Design)")
    print("  [OK] ASCE 7-22 (Load Determination)")
    print("  [OK] IBC 2021 (Building Code)")
    print("")
    print("Usage:")
